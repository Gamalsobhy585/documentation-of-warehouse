...
Welcome to the **Warehouse Module Developer Guide** — your reference for structure, integrations, and best practices.

## 📘 Start here
- [What is Warehouse?](what-is-warehouse.md)
- [Aim of the Warehouse](warehouse-aim.md)
- [Module Integration](module-connection.md)
